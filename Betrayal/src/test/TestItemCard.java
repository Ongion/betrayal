...
public class TestItemCard {
	...
	public void TestAngelFeatherInit() {
		assertEquals(mesEN.getString("titleAngelFeather"), angelFeatherCard.getName());
		assertEquals(mesEN.getString("desAngelFeather"), angelFeatherCard.getDescription());
		assertEquals(mesEN.getString("detailAngelFeather"), angelFeatherCard.getDetails());
		...
		assertEquals(mesSP.getString("titleAngelFeather"), angelFeatherCard.getName());
		assertEquals(mesSP.getString("desAngelFeather"), angelFeatherCard.getDescription());
		assertEquals(mesSP.getString("detailAngelFeather"), angelFeatherCard.getDetails());
	}

	@Test
	public void TestAdrenalineShotInit(){
		assertEquals(mesEN.getString("titleAdrenalineShot"), adrenalineShotCard.getName());
		assertEquals(mesEN.getString("desAdrenalineShot"), adrenalineShotCard.getDescription());
		assertEquals(mesEN.getString("detailAdrenalineShot"), adrenalineShotCard.getDetails());
		
		adrenalineShotCard = new AdrenalineShot(spLocale);
		assertEquals(mesSP.getString("titleAdrenalineShot"), adrenalineShotCard.getName());
		assertEquals(mesSP.getString("desAdrenalineShot"), adrenalineShotCard.getDescription());
		assertEquals(mesSP.getString("detailAdrenalineShot"), adrenalineShotCard.getDetails());
	...
	public void TestRevolverInit(){
		...
		assertEquals(mesEN.getString("desRevolver"), revolverCard.getDescription());
		assertEquals(mesEN.getString("detailRevolver"), revolverCard.getDetails());
		
		revolverCard = new Revolver(spLocale);
		assertEquals(mesSP.getString("titleRevolver"), revolverCard.getName());
		assertEquals(mesSP.getString("desRevolver"), revolverCard.getDescription());
		assertEquals(mesSP.getString("detailRevolver"), revolverCard.getDetails());
	...
	public void TestPuzzleBoxInit(){
		...
		assertEquals(mesEN.getString("detailPuzzleBox"), puzzleBoxCard.getDetails());
		
		puzzleBoxCard = new PuzzleBox(spLocale);
		assertEquals(mesSP.getString("titlePuzzleBox"), puzzleBoxCard.getName());
		assertEquals(mesSP.getString("desPuzzleBox"), puzzleBoxCard.getDescription());
		assertEquals(mesSP.getString("detailPuzzleBox"), puzzleBoxCard.getDetails());
	...
	public void TestRabbitsFootInit(){
		...
		assertEquals(mesEN.getString("detailRabbitsFoot"), rabbitsFootCard.getDetails());
		
		rabbitsFootCard = new RabbitsFoot(spLocale);
		assertEquals(mesSP.getString("titleRabbitsFoot"), rabbitsFootCard.getName());
		assertEquals(mesSP.getString("desRabbitsFoot"), rabbitsFootCard.getDescription());
		assertEquals(mesSP.getString("detailRabbitsFoot"), rabbitsFootCard.getDetails());
	...
	public void TestMedicalKitInit(){
		assertEquals(mesEN.getString("titleMedicalKit"), medicalKitCard.getName());
		assertEquals(mesEN.getString("desMedicalKit"), medicalKitCard.getDescription());
		assertEquals(mesEN.getString("detailMedicalKit"), medicalKitCard.getDetails());
		
		medicalKitCard = new MedicalKit(spLocale);
		assertEquals(mesSP.getString("titleMedicalKit"), medicalKitCard.getName());
		assertEquals(mesSP.getString("desMedicalKit"), medicalKitCard.getDescription());
		assertEquals(mesSP.getString("detailMedicalKit"), medicalKitCard.getDetails());
	...
	public void TestLuckyStoneInit(){
		assertEquals(mesEN.getString("titleLuckyStone"), luckyStoneCard.getName());
		assertEquals(mesEN.getString("desLuckyStone"), luckyStoneCard.getDescription());
		assertEquals(mesEN.getString("detailLuckyStone"), luckyStoneCard.getDetails());
		
		luckyStoneCard = new LuckyStone(spLocale);
		assertEquals(mesSP.getString("titleLuckyStone"), luckyStoneCard.getName());
		assertEquals(mesSP.getString("desLuckyStone"), luckyStoneCard.getDescription());
		assertEquals(mesSP.getString("detailLuckyStone"), luckyStoneCard.getDetails());
	...
	public void TestSacrificialDaggerInit(){
		assertEquals(mesEN.getString("titleSacrificialDagger"), sacrificialDaggerCard.getName());
		assertEquals(mesEN.getString("desSacrificialDagger"), sacrificialDaggerCard.getDescription());
		assertEquals(mesEN.getString("detailSacrificialDagger"), sacrificialDaggerCard.getDetails());
		
		sacrificialDaggerCard = new SacrificialDagger(spLocale);
		assertEquals(mesSP.getString("titleSacrificialDagger"), sacrificialDaggerCard.getName());
		assertEquals(mesSP.getString("desSacrificialDagger"), sacrificialDaggerCard.getDescription());
		assertEquals(mesSP.getString("detailSacrificialDagger"), sacrificialDaggerCard.getDetails());
	...
	public void TestMusicBoxInit(){
		...
		assertEquals(mesEN.getString("desMusicBox"), musicBoxCard.getDescription());
		assertEquals(mesEN.getString("detailMusicBox"), musicBoxCard.getDetails());
		
		musicBoxCard = new MusicBox(spLocale);
		assertEquals(mesSP.getString("titleMusicBox"), musicBoxCard.getName());
		assertEquals(mesSP.getString("desMusicBox"), musicBoxCard.getDescription());
		assertEquals(mesSP.getString("detailMusicBox"), musicBoxCard.getDetails());
	...
	public void TestHealingSalveInit(){
		assertEquals(mesEN.getString("titleHealingSalve"), healingSalveCard.getName());
		assertEquals(mesEN.getString("desHealingSalve"), healingSalveCard.getDescription());
		assertEquals(mesEN.getString("detailHealingSalve"), healingSalveCard.getDetails());
		
		healingSalveCard = new HealingSalve(spLocale);
		assertEquals(mesSP.getString("titleHealingSalve"), healingSalveCard.getName());
		assertEquals(mesSP.getString("desHealingSalve"), healingSalveCard.getDescription());
		assertEquals(mesSP.getString("detailHealingSalve"), healingSalveCard.getDetails());
	...
	public void TestAmuletOfAgesInit(){
		assertEquals(mesEN.getString("titleAmuletOfAges"), amuletOfAgesCard.getName());
		assertEquals(mesEN.getString("desAmuletOfAges"), amuletOfAgesCard.getDescription());
		assertEquals(mesEN.getString("detailAmuletOfAges"), amuletOfAgesCard.getDetails());
		
		amuletOfAgesCard = new AmuletOfAges(spLocale);
		assertEquals(mesSP.getString("titleAmuletOfAges"), amuletOfAgesCard.getName());
		assertEquals(mesSP.getString("desAmuletOfAges"), amuletOfAgesCard.getDescription());
		assertEquals(mesSP.getString("detailAmuletOfAges"), amuletOfAgesCard.getDetails());
	...
	public void TestDynamiteInit(){
		...
		assertEquals(mesEN.getString("desDynamite"), dynamiteCard.getDescription());
		assertEquals(mesEN.getString("detailDynamite"), dynamiteCard.getDetails());
		
		dynamiteCard = new Dynamite(spLocale);
		assertEquals(mesSP.getString("titleDynamite"), dynamiteCard.getName());
		assertEquals(mesSP.getString("desDynamite"), dynamiteCard.getDescription());
		assertEquals(mesSP.getString("detailDynamite"), dynamiteCard.getDetails());
	...
	public void TestPickpocketInit(){
		assertEquals(mesEN.getString("titlePickpoketsGloves"), pickpocketCard.getName());
		assertEquals(mesEN.getString("desPickpoketsGloves"), pickpocketCard.getDescription());
		assertEquals(mesEN.getString("detailPickpoketsGloves"), pickpocketCard.getDetails());
		
		pickpocketCard = new PickpocketsGloves(spLocale);
		assertEquals(mesSP.getString("titlePickpoketsGloves"), pickpocketCard.getName());
		assertEquals(mesSP.getString("desPickpoketsGloves"), pickpocketCard.getDescription());
		assertEquals(mesSP.getString("detailPickpoketsGloves"), pickpocketCard.getDetails());
	...
	public void TestSmellingSaltsInit(){
		assertEquals(mesEN.getString("titleSmellingSalts"), smellingSaltsCard.getName());
		assertEquals(mesEN.getString("desSmellingSalts"), smellingSaltsCard.getDescription());
		assertEquals(mesEN.getString("detailSmellingSalts"), smellingSaltsCard.getDetails());
		
		smellingSaltsCard = new SmellingSalts(spLocale);
		assertEquals(mesSP.getString("titleSmellingSalts"), smellingSaltsCard.getName());
		assertEquals(mesSP.getString("desSmellingSalts"), smellingSaltsCard.getDescription());
		assertEquals(mesSP.getString("detailSmellingSalts"), smellingSaltsCard.getDetails());
	...
	public void TestDarkDiceInit(){
		...
		assertEquals(mesEN.getString("desDarkDice"), darkDiceCard.getDescription());
		assertEquals(mesEN.getString("detailDarkDice"), darkDiceCard.getDetails());
		
		darkDiceCard = new DarkDice(spLocale);
		assertEquals(mesSP.getString("titleDarkDice"), darkDiceCard.getName());
		assertEquals(mesSP.getString("desDarkDice"), darkDiceCard.getDescription());
		assertEquals(mesSP.getString("detailDarkDice"), darkDiceCard.getDetails());
	...
	public void TestBloodDaggerInit(){
		assertEquals(mesEN.getString("titleBloodDagger"), bloodDaggerCard.getName());
		assertEquals(mesEN.getString("desBloodDagger"), bloodDaggerCard.getDescription());
		assertEquals(mesEN.getString("detailBloodDagger"), bloodDaggerCard.getDetails());
		
		bloodDaggerCard = new BloodDagger(spLocale);
		assertEquals(mesSP.getString("titleBloodDagger"), bloodDaggerCard.getName());
		assertEquals(mesSP.getString("desBloodDagger"), bloodDaggerCard.getDescription());
		assertEquals(mesSP.getString("detailBloodDagger"), bloodDaggerCard.getDetails());
